...
(http://godoc.org/github.com/looptrader/colonyd/dcrec/secp256k1)
...
```bash
$ go get -u github.com/looptrader/colonyd/dcrec
```

## Examples

* [Sign Message]
  (http://godoc.org/github.com/looptrader/colonyd/dcrec#example-package--SignMessage)  
  Demonstrates signing a message with a secp256k1 private key that is first
  parsed form raw bytes and serializing the generated signature.

* [Verify Signature]
  (http://godoc.org/github.com/looptrader/colonyd/dcrec#example-package--VerifySignature)  
  Demonstrates verifying a secp256k1 signature against a public key that is
  first parsed from raw bytes.  The signature is also parsed from raw bytes.

* [Encryption]
  (http://godoc.org/github.com/looptrader/colonyd/dcrec#example-package--EncryptMessage)
  Demonstrates encrypting a message for a public key that is first parsed from
  raw bytes, then decrypting it using the corresponding private key.

* [Decryption]
  (http://godoc.org/github.com/looptrader/colonydy/dcrec#example-package--DecryptMessage)
