...
(http://godoc.org/github.com/looptrader/colonyd/blockchain/chaingen)
...
* [Basic Usage Example]
  (http://godoc.org/github.com/looptrader/colonyd/blockchain/chaingen#example-package--BasicUsage)  
...
```bash
$ go get -u github.com/looptrader/colonyd/blockchain/chaingen
```
