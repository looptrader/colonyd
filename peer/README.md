...
(http://godoc.org/github.com/looptrader/colonyd/peer)
...
```bash
$ go get -u github.com/looptrader/colonyd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/looptrader/colonyd/peer#example-package--NewOutboundPeer)  
