...
|Returns|`{ (json object)`<br />&nbsp;&nbsp;`"isvalid": true or false,  (bool) whether or not the address is valid.`<br />&nbsp;&nbsp;`"address": "decredaddress", (string) the decred address validated.`<br />}|
[Return to Overview](#MethodOverview)<br />
